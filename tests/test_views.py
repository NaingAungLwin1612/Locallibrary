...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_user1.user_permissions.add(Permission.objects.get(codename='can_mark_returned'))
        test_user2 = User.objects.create_user(
            username="testuser2", password="2HJ1vRV0Z&3iD"
        )
        test_user2.user_permissions.add(Permission.objects.get(codename='can_mark_returned'))
...
class AuthorCreateTest(TestCase):
    ...
    def test_create_author(self):
        ...
        response = self.client.get(reverse("authors"))
        self.assertQuerysetEqual(response.context["author_list"],[author])